          ...
          <div class="row " style="margin-top: 200px;">
              <h2 style="font-size: 30px; font-weight:  bolder; font-family: serif; margin-left: 150px; color: #4ECDC4;  margin-top: -150px; 
               ...
               <style>
                   ...
                   <h3 class="h4" align="center" style=" color: white;  font-size: 23px; margin-bottom: 400px; font-family: monospace; margin-top: 50px; margin-left: -80px;"> Welcome  New User  ... </h3>
                           ...
                           <select name="group" style="background-color: skyblue;">
                            ...
                            <tr><td align="center" colspan="2"><button type="submit" style=" color: #2f323a; font-size: 15px; background-color:  #4ECDC4; font-family:monospace;">Register</button> </td></tr>
                                                           </table></form>
