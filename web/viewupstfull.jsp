               ...
               <style>
                    ...
                    th{
                                        ...
                                        font-family: monospace;
                                                    ...
                                                    <h3 class="h4" align="center" style=" color: white; font-size: 23px; margin-bottom: 400px; font-family: monospace; margin-top: 100px; margin-left: -80px; ">View users Post by Group... </h3>
						  <%                    
      String grup=session.getAttribute("grup").toString();
    
      Class.forName("com.mysql.jdbc.Driver");
                        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/group","root","root");
                        PreparedStatement query=con.prepareStatement("select * from post where grup='"+grup+"' ");
                        ResultSet rs=query.executeQuery();
                        System.out.println(query);
                        while(rs.next()){
                         %>
                         <table style="margin-left: 160px; color: skyblue; font-family: monospace;">
                            <tr>
