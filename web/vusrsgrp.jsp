    ...
    <section id="main-content" style=" background-color: #2f323a;">
      <section class="wrapper">
          <div class="row " style="margin-top: 200px;">
            ...
            <h3 class="h4" align="center" style=" color: white; font-size: 23px; margin-bottom: 400px; font-family: monospace; margin-top: 50px; margin-left: -60px; ">View users by Group... </h3>
		 <table>					
            <tr>                                               
            <th>Group</th>
           <th>Details</th>
                        ...
                        while(rs.next()){
                         %>
                          ...
                          <tr>
                           ...
                           <td><a style=" background-color: skyblue; color:  black;" href="viewufull.jsp">View Details</a></td>
                      <%}%>
            </tr></table>
