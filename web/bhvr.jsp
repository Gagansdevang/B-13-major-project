  ...
  <section id="container">
    ...
    <section id="main-content" style=" background-color: #2f323a;">
      ...
      <main >
                ...
                <br>
                <br>
                <a  href="pst.jsp"><h4>Positive Vibes based on Posts</h4></a> 
                <a href="neg.jsp"><h4>Negative Vibes based on Posts</h4></a>
                 <a href="neu.jsp"><h4>Neutral Vibes based on Posts</h4></a>
