               ...
               <style>
                    ...
                    th{
                                        ...
                                        font-family: monospace;
                                                    ...
                                                    <h3 class="h4" align="center" style=" color: white; font-size: 23px; margin-bottom: 400px; font-family: monospace; margin-top: 100px; margin-left: -80px; ">View users by Group... </h3>
						  <%                    
                        ...
                        while(rs.next()){
                         %>
                         <table style="margin-left: 380px; color: skyblue; font-family: monospace;">
                            <tr>
