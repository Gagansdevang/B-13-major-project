    ...
    <section id="main-content" style=" background-color: #2f323a;">
      <section class="wrapper">
          <div class="row " style="">
              ...
              <h2 style="font-size: 30px; font-weight:  bolder; font-family: serif; margin-left: 250px; color: #4ECDC4;  
                "> Social Recommendation With Learning Personal and Social Latent Factors</h2>
                        <h3 class="h4" align="center" style=" color: white; font-size: 23px; font-family: monospace;margin-left: -80px; margin-bottom: 100px;">View  all recommded post... </h3>
                        <%   
                        ...
                        PreparedStatement query=con.prepareStatement("select * from recommed where grup='"+grup+"' ");
                        ResultSet rs=query.executeQuery();
                        System.out.println(query);
                        while(rs.next()){
                         %>
                         <table style=" color: skyblue; font-family: monospace;">
