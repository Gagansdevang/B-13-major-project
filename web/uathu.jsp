              ...
              <h2 style="font-size: 30px; font-weight:  bolder; font-family: serif; margin-left: 280px; color: #4ECDC4;  margin-top: -150px; 
               ...
               <style>
                      ...
                      th{
                        ...
                        <h3 class="h4" align="center" style=" color: white; font-size: 23px; margin-bottom: 400px; font-family: monospace; margin-top: 50px; margin-left: -80px; "> View all users and Authorize ... </h3>
                     ...
                     <%                    
                      ...
                      %>
                            ...
                            <td><img src="profile/<%=rs.getString("profile")%>" alt="image" style="width:80px; height: 80px;"></td>
                            <td><%=rs.getString("user")%></td>  
                            <td><%=rs.getString("location")%></td>
                            <td><%=rs.getString("grup")%></td>
                            <td > <a href="uactive.jsp?id=<%=rs.getString("id")%>" style="color: blue ; "><%=rs.getString("status")%></a></td></tr>
