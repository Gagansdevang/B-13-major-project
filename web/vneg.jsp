      ...
      <section class="wrapper">
        <div class="row">
             ...
             <main >
                ...
                <h2 style="font-size: 30px; font-weight:  bolder; font-family: serif; margin-left: 350px; color: #4ECDC4;  margin-top: 100px; 
                "> Social Recommendation With Learning Personal and Social Latent Factors</h2> 
                
                <h3 class="h4" align="center" style=" color: white; font-size: 23px; margin-bottom: 600px; font-family: monospace; margin-top: 100px; margin-left: -80px;"> Negative Vibes based on Posts</h3>
               ...
               >
                ...
                <style>
                   ...
                   <table style="margin-top: -500px; width: 60%; margin-left: 250px;">
                       <tr>
                           <th>S.No</th>
                           <th>User Name</th>
                           <th>Topic</th>
          ...
          <%  
                        ...
                        PreparedStatement query=con.prepareStatement("select * from post  ");
                        ResultSet rs=query.executeQuery();
                        System.out.println(query);
                        while(rs.next()){
                            String tweet=rs.getString("description");
                         %>
            ...
            for(int i=0;i<word.length;i++)
                {
                PreparedStatement query1=con.prepareStatement("select * from neg where negative='"+word[i]+"'  ");
                ...
                if(rs1.next())
                {
                           ...
                           <td> <%=rs.getString("grup")%></td>
                            ...
                            <%
                  PreparedStatement query4=con.prepareStatement("update post set status='negative' where sno='"+rs.getString("sno")+"'");
