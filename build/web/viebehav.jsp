  ...
  <section id="container">
    ...
    <section id="main-content" style=" background-color: #2f323a;">
      ...
      <main >
                   ...
                   <h1 style=" color: whitesmoke; font-size:30px; font-family:  monospace; align:centre; font-weight:Bolder; margin-left: 650px; margin-top: 70px; ">Behaviour Prediction  <h1>
                ...
                <br>
                <br>
                <a  href="vpst.jsp"><h4>Positive Vibes based on Posts</h4></a> 
                <a href="vneg.jsp"><h4>Negative Vibes based on Posts</h4></a>
                 <a href="vneu.jsp"><h4>Neutral Vibes based on Posts</h4></a>
