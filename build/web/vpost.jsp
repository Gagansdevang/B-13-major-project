        ...
        <div class="row">
             ...
             <main >
                ...
                table{
                    border-radius: 20px;
                       ...
                       <div style="margin-top: -220px;">
                         <div>
                    <br><br><br></div>
                <h3 class="h4" align="center" style=" color: white; font-size: 23px; margin-bottom: 600px; font-family: monospace; margin-top: 100px; margin-left: -80px; "> View Friends and Send request. </h3>
							
                <h2 style="font-size: 30px; font-weight:  bolder; font-family: serif; margin-left: 550px; color: #4ECDC4;  margin-top: -500px; 
                "> Social Recommendation With Learning Personal and Social Latent Factors</h2>   <br>
                 <h1 style="color: white;font-size: 23px; font-weight:bold; font-family: monospace; margin-left: 590px;"><strong> View  post and Recommed to Groups</strong></h1>
                ...
                <style>
                   ...
                   <table style="margin-top: 50px; width: 60%; margin-left: 350px;">
                       <tr>
                           <th>User Name</th>
                           <th>Topic</th>
                           <th>Image</th>
