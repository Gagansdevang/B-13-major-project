    ...
    <section id="main-content" style=" background-color: #2f323a;">
      <section class="wrapper">
        ...
        <div class="header-text">
            <br>
            <br>
             <h3 class="h4" align="center" style=" color: white; font-size: 23px; margin-bottom: 100px; font-family: monospace; margin-top: 100px; margin-left:150px; "> View all Recommended post </h3>
