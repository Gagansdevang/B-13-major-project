...
<body>
    ...
    <section id="main-content" style=" background-color: #2f323a;">
      <section class="wrapper">
        ...
        <div class="header-text">
             ...
             <h3 class="h4" align="center" style=" color: white; font-size: 23px; margin-bottom: 400px; font-family: monospace; margin-top: 100px; margin-left: 50px; "> Profile... </h3>
							
                <h2 style="font-size: 30px; font-weight:  bolder; font-family: serif; margin-left: 550px; margin-bottom: 300px; color: #4ECDC4;  margin-top: -500px; 
  ...
  <%                    
      ...
      Class.forName("com.mysql.jdbc.Driver");
                        ...
                        PreparedStatement query=con.prepareStatement("select * from ureg Where id='"+id+"' and user='"+name+"'");
