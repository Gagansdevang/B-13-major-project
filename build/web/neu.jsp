      ...
      <section class="wrapper">
        <div class="row">
              ...
              <main >
                ...
                <h2 style="font-size: 30px; font-weight:  bolder; font-family: serif; margin-left: 450px; color: #4ECDC4;  margin-top: 100px; 
                "> Social Recommendation With Learning Personal and Social Latent Factors</h2> 
                
                <h3 class="h4" align="center" style=" color: white; font-size: 23px; margin-bottom: 600px; font-family: monospace; margin-top: 100px; margin-left: -80px;"> Neutral Vibes based on Posts</h3>
