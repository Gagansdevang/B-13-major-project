    ...
    <section id="main-content" style=" background-color: #2f323a;">
      <section class="wrapper">
          <div class="row " style="margin-top: 200px;">
            ...
            <h3 class="h4" align="center" style=" color: white; font-size: 23px; margin-bottom: 400px; font-family: monospace; margin-top: 50px; margin-left: -80px; ">View all Recommended By Group... </h3>
		 <table>					
            <tr>                                               
            <th>Group</th>
           <th>Details</th>
                     ...
                     <%        
                        ...
                        PreparedStatement query=con.prepareStatement("select * from recommed group by grup " );
                        ...
                        while(rs.next()){
                         %>
                          ...
                          <tr>
                           ...
                           <td><a style=" background-color: skyblue; color:  black;" href="viewfullrcmd.jsp?grup=<%=rs.getString("grup")%>">View Details</a></td>
                      <%}%>
            </tr></table>
